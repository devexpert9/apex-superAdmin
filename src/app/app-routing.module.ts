...
// Auth
import { AuthGuard } from './views/pages/core/auth.guard';
...
const routes: Routes = [
  ...
  {path: 'error', loadChildren: () => import('./views/pages/error/error.module').then(m => m.ErrorModule)},
  {
    ...
    children: [
      ...
      {
        path: 'user-management/inquiries',
        loadChildren: () => import('./views/pages/user-management/user-management.module').then(m => m.UserManagementModule),
      },
      {
        path: 'settings',
      ...
      {
        path: 'my-page',
        loadChildren: () => import('./views/pages/my-page/my-page.module').then(m => m.MyPageModule),
      },
      {
        path: 'builder',
