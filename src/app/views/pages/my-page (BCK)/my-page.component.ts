    	...
    	if(this.pageData.length > 0){
          ...
          property_casuality: this.pageData[index].property_casuality_content
    		...
    		if(this.pageData[index].selfservice_image != '')
    		{
    			...
    			document.getElementById('ban_img').setAttribute("src",'https://apex-4u.com:8080/images/'+this.pageData[index].selfservice_image);
    		}else{
	      	...
	      	if(this.pageData[index].disability_image != ''){
    			...
    			document.getElementById('ban_img1').setAttribute("src",'https://apex-4u.com:8080/images/'+this.pageData[index].disability_image);
    		}else{
    		...
    		if(this.pageData[index].property_casuality_image != ''){
    			...
    			document.getElementById('ban_img2').setAttribute("src",'https://apex-4u.com:8080/images/'+this.pageData[index].property_casuality_image);
    		}else{
